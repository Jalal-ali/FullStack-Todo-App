...
<p className='text-white xl:text-xl cursor-pointer border-b border-cyan-800 first-letter:uppercase text-md font-light my-1 text-center'>{email}</p>
...
{outBtn ? <button onClick={logout} type="button" className="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-1">Logout</button>
: null}
